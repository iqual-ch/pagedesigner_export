  ...
  public function getTools(): array {
    ...
    return [
      ...
      new Tool(
        ...
        description: 'Export the site design as data: the default theme chain, iq_barrio.settings verbatim, the resolved colour palette (name to hex) and, per Pagedesigner pattern, the toggleable classes and styling-option selects. Same shape as theme.json of the drush package.',
        inputSchema: [
          'type' => 'object',
          'properties' => (object) [],
          'required' => [],
